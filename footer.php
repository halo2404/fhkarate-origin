	...
	<div class="container">
		...
		<div class="row">
			<div id="vfooter" class="col-md-12" role="navigation">
				<div class="col-md-3">
					<p><?php wp_nav_menu(array('theme_location'=>'secondary')); ?></p>
				</div>
				<div class="col-md-3">
			...
			<div id="footer" class="col-md-12" role="footer">
				<p>Copyright &copy; 2015 &bull; All Rights Reserved &bull; <a href="<?php bloginfo('url') ?>">fh-karate.de</a></p>
			</div>
		</div>
	</div>
	</footer>
